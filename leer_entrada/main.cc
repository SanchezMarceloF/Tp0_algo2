...
// 07/11/2020 se cambia el nombre a leer_entrada.cpp Sanchez Marcelo
...
opt_difficulty(string const &arg)
{
	...
	//acá verificamos que el entero sea menor a 6.
//	if (int (iss >> difficulty) > 5) {
//		cerr << "el programa no puede procesar un nivel	de dificultad = "
//		     << arg 
//		     << "."
//	             << endl;
//		exit(1);
